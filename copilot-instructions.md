...
1.  **Commit Often**: Make small, frequent commits with clear messages.
    Use the present tense, imperative mood (“Add feature” not ” I added
    feature”).
2.  **Branching**: Use branches for new features or bug fixes. Merge
    back to the main branch when complete.
3.  **Pull Requests**: Use pull requests for code reviews and
    discussions before merging changes.

## Error Handling

Prefer using [`stopifnot()`](https://rdrr.io/r/base/stopifnot.html) for
...
When suggesting changes during code review, use TDD as well. That is,
make the suggested change explicit by writing a failing test. Then,
follow the TDD process to make the test pass and refactor the code as
needed.
