...
Thanks for using apr! Before filing an issue, there are a few places to
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/11rchitwood/apr/issues/new).
...
requests](https://github.com/11rchitwood/apr/issues) to make sure the
