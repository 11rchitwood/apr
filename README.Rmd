...
The following table lists all APL glyphs and their corresponding monadic and dyadic function names in the `apr` package:

| Glyph | Monadic Name | Dyadic Name |
|-------|--------------|-------------|
...
*Note: "—" indicates that the glyph does not have a standard monadic or dyadic form in APL.*
