...
This outlines how to propose a change to apr. For a detailed discussion
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("11rchitwood/apr", fork = TRUE)`.
...
Please note that the apr project is released with a [Contributor Code of
Conduct](https://11rchitwood.github.io/apr/CODE_OF_CONDUCT.md). By
